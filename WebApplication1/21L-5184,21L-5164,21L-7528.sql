...
Insert Into Booking (Room_ID,Billing_ID,CurrentDate,NumberOfDays) Values (2,3,'2023-05-12',1) 
Update Room set isBooked='True' where Room_ID=2  
Update Booking set isBooked='True' where Room_ID=2 and Billing_ID=3
