...
(Room_ID int foreign key References Room(Room_ID) on delete set null on update cascade, 
...
Create Table Orders 
(Food_ID int foreign key References Menu(Food_ID) on delete set null on update cascade, 
Billing_ID int foreign key References Billing(Billing_ID),
Quantity int); 
...
(Offer_ID int foreign key References SalesAndOffers(Offer_ID) on delete set null on update cascade, 
Billing_ID int foreign key References Billing(Billing_ID));  
